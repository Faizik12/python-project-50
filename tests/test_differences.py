...
def simple_diff():
    return {
        ...
        'children':
        {
            ...
            {
                'status': 'correct',
                'correct value': 'hexlet.io'
            },
            'proxy':
            {
                'status': 'deleted',
                'correct value': '123.234.53.22'
            },
            'timeout':
            {
                'status': 'changed',
...
def complex_diff():
    return {
        ...
        'children':
        {
            ...
            {
                'status': 'node',
                'sorted keys': ['follow', 'setting1', 'setting2',
                                'setting3', 'setting4', 'setting5', 'setting6'],
                'children':
                {
                    'follow':
                    {
...
def test_get_keys(simple_diff):
    assert get_keys(simple_diff) == ['follow', 'host',
